...
mixin _$RoundModel {
  ...
  List<ContentUnitModel> get contentUnitList =>
...
abstract class $RoundModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      int roundSeq,
      String name,
      List<ContentUnitModel> contentUnitList});
}
...
class _$RoundModelImpl implements _RoundModel {
  _$RoundModelImpl(
      ...
      required this.name,
      required final List<ContentUnitModel> contentUnitList})
  ...
  @override
  final String name;
  final List<ContentUnitModel> _contentUnitList;
  @override
  List<ContentUnitModel> get contentUnitList {
  ...
  @override
  String toString() {
    return 'RoundModel(id: $id, roundSeq: $roundSeq, name: $name, contentUnitList: $contentUnitList)';
  }
